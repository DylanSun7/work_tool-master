<template>
  <div class="container">
    <h2>图片损坏检测</h2>
    <p style="color: #2981e6; font-size: 15px; font-weight: bold; margin: 10px">
      功能: 筛选损坏的图片文件, 返回正常图片文件
    </p>
    <p style="color: #2981e6; font-size: 15px; font-weight: bold; margin: 10px">
      使用说明: 上传含图片的zip格式压缩包文件, 压缩包内应包含一个文件夹,
      上传成功点击提交即可
    </p>
  ...
  <div style="text-align: center;">
    ...
    <li>
      <form @submit.prevent="uploadFile"><button type="submit" class="submit-button">提交</button></form>
    </li>
